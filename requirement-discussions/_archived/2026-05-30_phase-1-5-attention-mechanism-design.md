> 🗄️ **已封存(2026-06-02 防污染整治)** — 注意力/双OCR架构本体**被 stack-centric §15 范式取代,死**。
> 仍活的内容(14 域约束 / 摊牌捕获专项 / spike A)已蒸馏至
> **`主题-数据质量.md` → `2026-06-01_95pct-constraint-solver-paradigm.md` §16**。本文件只读、保历史链,勿当现行。
